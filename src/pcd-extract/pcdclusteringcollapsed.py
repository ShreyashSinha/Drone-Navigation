...
bounds = np.array([[-42.21272548,-36.97328892,3.0],[42.8565817,-36.97328892,3.0],[42.8565817,36,3.0],
                   [-42.21272548,36,3.0],[-42.21272548,-36.97328892,23.04677824],[42.8565817,-36.97328892,23.04677824],
                   [42.8565817,36,23.04677824],[-42.21272548,36,23.04677824]])
...
with o3d.utility.VerbosityContextManager(
    ...
    labels = np.array(
        cropped_pcd.cluster_dbscan(eps=0.8, min_points=90, print_progress=True))
...
#     demo_pc.points = o3d.utility.Vector3dVector(np.array(v))
